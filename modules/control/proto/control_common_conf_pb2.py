...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_control__msgs_dot_pad__msg__pb2.DESCRIPTOR,])
...
_CONTROLCOMMONCONF.fields_by_name['driving_mode'].enum_type = modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2._CHASSIS_DRIVINGMODE
_CONTROLCOMMONCONF.fields_by_name['action'].enum_type = modules_dot_common__msgs_dot_control__msgs_dot_pad__msg__pb2._DRIVINGACTION

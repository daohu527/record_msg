...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2.DESCRIPTOR,modules_dot_drivers_dot_microphone_dot_proto_dot_microphone__config__pb2.DESCRIPTOR,])
...
_AUDIODATA.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER

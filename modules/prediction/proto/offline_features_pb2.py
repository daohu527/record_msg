...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_basic__msgs_dot_pnc__point__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_prediction__msgs_dot_feature__pb2.DESCRIPTOR,modules_dot_prediction_dot_proto_dot_prediction__conf__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_prediction__msgs_dot_scenario__pb2.DESCRIPTOR,])
...
_PREDICTIONRESULT.fields_by_name['trajectory'].message_type = modules_dot_common__msgs_dot_prediction__msgs_dot_feature__pb2._TRAJECTORY
...
_PREDICTIONRESULT.fields_by_name['scenario'].message_type = modules_dot_common__msgs_dot_prediction__msgs_dot_scenario__pb2._SCENARIO
_LISTPREDICTIONRESULT.fields_by_name['prediction_result'].message_type = _PREDICTIONRESULT
_LISTFRAMEENV.fields_by_name['frame_env'].message_type = modules_dot_common__msgs_dot_prediction__msgs_dot_feature__pb2._FRAMEENV
_DATAFORTUNING.fields_by_name['adc_trajectory_point'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_pnc__point__pb2._TRAJECTORYPOINT
_LISTDATAFORTUNING.fields_by_name['data_for_tuning'].message_type = _DATAFORTUNING
_FEATURES.fields_by_name['feature'].message_type = modules_dot_common__msgs_dot_prediction__msgs_dot_feature__pb2._FEATURE

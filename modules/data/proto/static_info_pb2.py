...
_VEHICLEINFO.fields_by_name['license'].message_type = modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2._LICENSE
_VEHICLEINFO.fields_by_name['canbus_conf'].message_type = modules_dot_canbus_dot_proto_dot_canbus__conf__pb2._CANBUSCONF
_VEHICLEINFO.fields_by_name['vehicle_config'].message_type = modules_dot_common__msgs_dot_config__msgs_dot_vehicle__config__pb2._VEHICLECONFIG
...
_SOFTWAREINFO.fields_by_name['latest_routing_request'].message_type = modules_dot_common__msgs_dot_routing__msgs_dot_routing__pb2._ROUTINGREQUEST

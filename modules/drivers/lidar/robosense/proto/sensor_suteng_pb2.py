...
SutengPacket = _reflection.GeneratedProtocolMessageType('SutengPacket', (_message.Message,), dict(
...
SutengScan = _reflection.GeneratedProtocolMessageType('SutengScan', (_message.Message,), dict(

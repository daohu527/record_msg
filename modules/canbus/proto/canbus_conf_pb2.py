...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_drivers__msgs_dot_can__card__parameter__pb2.DESCRIPTOR,modules_dot_canbus_dot_proto_dot_vehicle__parameter__pb2.DESCRIPTOR,])
...
_CANBUSCONF.fields_by_name['can_card_parameter'].message_type = modules_dot_common__msgs_dot_drivers__msgs_dot_can__card__parameter__pb2._CANCARDPARAMETER

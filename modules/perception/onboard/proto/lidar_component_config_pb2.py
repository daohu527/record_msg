...
_LIDARDETECTIONCOMPONENTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=_b("/apollo/modules/perception/pipeline/config").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=_b("lidar_detection_pipeline.pb.txt").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
  ],

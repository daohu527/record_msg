...
_IMPENDINGCOLLISIONEDGE.fields_by_name['point'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_geometry__pb2._POINT3D
_IMPENDINGCOLLISIONEDGES.fields_by_name['impending_collision_edge'].message_type = _IMPENDINGCOLLISIONEDGE
_IMPENDINGCOLLISIONEDGES.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER

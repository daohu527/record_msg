...
_LIDAROBSTACLEDETECTIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='preprocessor', full_name='apollo.perception.lidar.LidarObstacleDetectionConfig.preprocessor', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("PointCloudPreprocessor").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='detector', full_name='apollo.perception.lidar.LidarObstacleDetectionConfig.detector', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_map_manager', full_name='apollo.perception.lidar.LidarObstacleDetectionConfig.use_map_manager', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_object_filter_bank', full_name='apollo.perception.lidar.LidarObstacleDetectionConfig.use_object_filter_bank', index=3,

...
_STREAMSTATUS.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
...
_INSSTATUS.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER
_INSSTATUS.fields_by_name['type'].enum_type = _INSSTATUS_TYPE
_INSSTATUS_TYPE.containing_type = _INSSTATUS
_GNSSSTATUS.fields_by_name['header'].message_type = modules_dot_common__msgs_dot_basic__msgs_dot_header__pb2._HEADER

...
# source: modules/perception/pipeline/proto/plugin/dst_type_fusion_config.proto
...
CameraDstTypeFusionParam = _reflection.GeneratedProtocolMessageType('CameraDstTypeFusionParam', (_message.Message,), dict(
  ...
  __module__ = 'modules.perception.pipeline.proto.plugin.dst_type_fusion_config_pb2'

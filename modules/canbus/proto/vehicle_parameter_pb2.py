...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_config__msgs_dot_vehicle__config__pb2.DESCRIPTOR,])
...
_VEHICLEPARAMETER.fields_by_name['brand'].enum_type = modules_dot_common__msgs_dot_config__msgs_dot_vehicle__config__pb2._VEHICLEBRAND
_VEHICLEPARAMETER.fields_by_name['driving_mode'].enum_type = modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2._CHASSIS_DRIVINGMODE

...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_perception__msgs_dot_perception__obstacle__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_prediction__msgs_dot_feature__pb2.DESCRIPTOR,])
...
_OBSTACLECONF.fields_by_name['obstacle_type'].enum_type = modules_dot_common__msgs_dot_perception__msgs_dot_perception__obstacle__pb2._PERCEPTIONOBSTACLE_TYPE
_OBSTACLECONF.fields_by_name['obstacle_status'].enum_type = _OBSTACLECONF_OBSTACLESTATUS
_OBSTACLECONF.fields_by_name['priority_type'].enum_type = modules_dot_common__msgs_dot_prediction__msgs_dot_feature__pb2._OBSTACLEPRIORITY_PRIORITY
_OBSTACLECONF.fields_by_name['interactive_tag'].enum_type = modules_dot_common__msgs_dot_prediction__msgs_dot_feature__pb2._OBSTACLEINTERACTIVETAG_INTERACTIVETAG

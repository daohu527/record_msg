...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2.DESCRIPTOR,modules_dot_common__msgs_dot_localization__msgs_dot_pose__pb2.DESCRIPTOR,])
...
_VEHICLESTATE.fields_by_name['gear'].enum_type = modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2._CHASSIS_GEARPOSITION
_VEHICLESTATE.fields_by_name['driving_mode'].enum_type = modules_dot_common__msgs_dot_chassis__msgs_dot_chassis__pb2._CHASSIS_DRIVINGMODE
_VEHICLESTATE.fields_by_name['pose'].message_type = modules_dot_common__msgs_dot_localization__msgs_dot_pose__pb2._POSE
